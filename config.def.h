...
#else
static const char *fonts[]               = { "Product Sans:pixelsize=13:weight=bold:antialias=true" };
...
static const char *const autostart[] = {
    ...
    "picom", NULL,
    "sxhkd", NULL,
    "xsettingsd", "-c", "~/.config/xsettingsd/xsettingsd-dwm.conf", NULL,
    "xfce4-power-manager", "--deamon", NULL,
    "dunst", NULL,
    "xidlehook", "--not-when-fullscreen", "--not-when-audio", "--timer", "600", "'slock'", "''", NULL,
    "emacs", "--daemon", NULL,
    "mpd", NULL,
    "eval", "$(gnome-keyring-daemon --start)", NULL,
    "export", "SSH_AUTH_SOCK", NULL,
...
static char *tagicons[][NUMTAGS] = {
	[DEFAULT_TAGS]        = { "www", "media", "prod", "term", "game" },
